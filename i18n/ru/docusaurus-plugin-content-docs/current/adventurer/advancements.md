...
id: advancements
title: Улучшения
hoverText: Когда приключенец улучшает свои характеристики или навыки, это считается улучшением.
---

Когда приключенец улучшает свои характеристики или навыки, это считается
улучшением. Некоторые из таких улучшений требуют потратить
[XP](/docs/glossary/xp) во время этапа «Получение улучшений» [фазы
награды](/docs/campaign/day/reward-phase). Некоторые игровые эффекты также дают
