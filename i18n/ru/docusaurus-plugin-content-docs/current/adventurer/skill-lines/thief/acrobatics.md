...
:::tip[FAQ] **Can I use Fleet Phantom to get adjacent to an Elusive enemy and be
eligible to damage it?**
...
:::info You occupy every hex you move into. When you move through already
...
:::tip[FAQ] **If you move through the same enemy multiple times during a single
move action, does this deal damage per occurrence?**
...
:::info **How does Wind Walker interact with the item Wood Elf Breeches?**
...
:::info **Can you resolve Duelist's Rebuff without an adjacent enemy to redirect
the damage to?**
...
:::info **Can I benefit from the reroll Defiance provides during the same engage
that it has been placed into the cooldown track?**
