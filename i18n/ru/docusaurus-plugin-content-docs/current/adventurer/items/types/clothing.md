...
Clothing items grant additional utility and flexibility. Each
<img src="/icons/clothing.svg" alt="Clothing Icon" className="icon-svg"/> item
adds an additional [class ability](/docs/battles/adventurer-turn/class-ability).
Class abilities can be triggered as an action during battle by spending
