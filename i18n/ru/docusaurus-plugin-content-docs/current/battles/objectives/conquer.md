...
The [party](/docs/glossary/party) must [defeat](/docs/glossary/defeated) or
otherwise remove all enemies on the battle map. This is the most common
objective for [clashes](/docs/battles/types/clash), and it can occasionally
appear in [dungeon](/docs/battles/types/dungeon) battles.
