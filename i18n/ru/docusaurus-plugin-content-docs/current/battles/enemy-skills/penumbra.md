...
После того как эта [боевая единица](/docs/glossary/unit) [повержена](/docs/glossary/defeated), она заменяет [слабейшую](/docs/glossary/weakest) союзную не-[сюжетную боевую единицу](/docs/glossary/quest-unit) и получает её фишки ОЗ и кубики состояний. Заменённая боевая единица возвращается в мешочек врагов.
...
**Может ли боевая единица с «Полутенью» получить состояние [«Страх»](/docs/battles/status-effects/fear)?**
