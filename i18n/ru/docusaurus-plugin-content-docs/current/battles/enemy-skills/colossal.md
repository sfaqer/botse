...
This [unit](/docs/glossary/unit) deploys with additional HP equal to the total
number of [Combat](/docs/adventurer/skill-lines/warrior/combat) skill dice
trained by [adventurers](/docs/glossary/adventurer).

---

:::info **What counts as trained?**
...
The HP granted by the skill Colossal is **additional** HP. The unit's Health
