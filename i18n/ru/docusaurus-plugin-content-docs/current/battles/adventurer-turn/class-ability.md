...
Даже если в них не используется слово «можно», врождённые способности с памяток классов, а также любые постоянные способности класса являются необязательными. Вы не обязаны использовать их, если не хотите.
