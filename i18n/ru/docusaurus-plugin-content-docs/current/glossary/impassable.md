...
- [Боевая единица](/docs/glossary/unit) не может передвигаться через непроходимую клетку.
- Расстояние и [дальность](/docs/glossary/range) нельзя считать через непроходимые клетки.
- Непроходимые клетки нельзя выбирать целью или подвергать воздействию других способностей.
