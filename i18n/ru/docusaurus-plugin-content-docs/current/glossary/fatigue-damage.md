...
At the start of each fatigue round, each [adventurer](/docs/glossary/adventurer)
gains 1 [overfatigue](/docs/glossary/fatigue) die. Then, each adventurer is
dealt [true damage](/docs/glossary/true-damage) equal to the total number of
overfatigue in their [cooldown track](/docs/glossary/cooldown-track).
